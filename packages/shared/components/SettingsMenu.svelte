...
<div class="flex-1 w-full">
    ...
    {#each Object.values(settings) as setting}
        <button
            ...
            class="group flex flex-row justify-start items-center hover:bg-blue-50 dark:hover:bg-gray-800 dark:hover:bg-opacity-20 py-2 rounded-lg w-3/4 text-left {!Object.values(
                activeSettings
